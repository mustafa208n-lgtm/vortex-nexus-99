...
# --- قسم مرجع الـ 49 نقطة المضاف بدون حذف الكود القديم ---
st.sidebar.markdown("---")
show_reference = st.sidebar.checkbox("📖 عرض مرجع الـ 49 فكرة والصناديق بالكامل")

if show_reference:
    st.markdown("---")
    st.header("📋 الدليل الشامل لجميع الأفكار الـ 49 في تطبيق AutoVolt AI")
    
    st.subheader("الصندوق 1: الحساسات والمكابس الهيدروليكية")
    st.markdown("- **النقطة 1:** مستشعر قراءة ضغط الهايدروليك الحي بالبار.")
    st.markdown("- **النقطة 2:** مستشعر فحص تذبذب واهتزاز مكبس الحديد.")
    st.markdown("- **النقطة 3:** مستشعر حرارة المحرك المركزي.")
    st.markdown("- **النقطة 4:** سلايدر التحكم البشري بالأحمال.")
    st.markdown("- **النقطة 5:** عداد ساعات التشغيل التراكمي.")
    st.markdown("- **النقطة 6:** مؤشر تقدير إجهاد وسهو العامل (توافقاً مع قانون الذكاء الاصطناعي الأوروبي).")

    st.subheader("الصندوق 2: واجهة التصميم ونظام الإنذار الصامت")
    st.markdown("- **النقطة 7:** حقق نمط التصميم الصناعي الأوروبي الهادئ (Zen Industrial Style).")
    st.markdown("- **النقطة 8:** بطاقات مؤشرات الأداء الرقمية النظيفة والموحدة لعرض كاش العمولات والميزانية.")
    st.markdown("- **النقطة 9:** جدار الإنذار الوميضي الأحمر الصارم المحمي بقفل التحديث لمنع التهنيج.")
    st.markdown("- **النقطة 10:** نظام الإشارات الثلاثي الصامت لتلخيص وضع المصنع بنظرة واحدة.")
    st.markdown("- **النقطة 11:** نمط التكبير التلقائي للوردية الليلية.")
    st.markdown("- **النقطة 12:** نظام الإغلاق الآمن عند الفشل (Fail-Closed).")

    st.subheader("الصندوق 3: خوارزميات الذكاء الاصطناعي وخدمات الـ Micro-SaaS")
    st.markdown("- **النقطة 13:** محرك التدريب والتنبؤ بالمخاطر عبر خوارزمية الغابات العشوائية (RandomForest).")
    st.markdown("- **النقطة 14:** باقات الاشتراكات الجزئية للخدمات المصغرة (Micro-SaaS).")
    st.markdown("- **النقطة 15:** معمارية فصل الخادم الخلفي (Backend) وعرض واجهة برمجة التطبيقات.")
    st.markdown("- **النقطة 16:** شاشة عرض حمولة الـ REST API المشفرة بصيغة JSON.")
    st.markdown("- **النقطة 17:** عامل وسيط الرسائل (Mosquitto MQTT Worker).")
    st.markdown("- **النقطة 18:** معالجة وتغذية البيانات اللوجستية عبر طابور غير محظور في الخلفية.")

    st.subheader("الصندوق 4: الأقفال السيبرانية وسجل التدقيق الحماية الأمنية")
    st.markdown("- **النقطة 19:** قفل حظر صلاحية المسح والتعديل الجنائي لبرء الذمة من الضرائب.")
    st.markdown("- **النقطة 20:** قبو الهوية السيادية الأوروبية للتحقق الثنائي.")
    st.markdown("- **النقطة 21:** قفل ربط وثبيت الحساب وعنوان الـ IP وبصمة المتصفح.")
    st.markdown("- **النقطة 22:** قفل التشفير الفيزيائي المتبادل للمستشعرات (mTLS Handshake).")
    st.markdown("- **النقطة 23:** قفل التحكم في الوصول المستند إلى الأدوار (RBAC).")
    st.markdown("- **النقطة 24:** قفل جدار الحماية ضد الغمر السيبراني والـ DDoS المنظم.")
    st.markdown("- **النقطة 25:** قفل حماية روابط سحب الأرباح بخوارزميات الـ HMAC-SHA256 المتجددة.")
    st.markdown("- **النقطة 26:** نظام التحقق الحيوي ثلاثي الأبعاد أو عبر رمز الـ SMS.")
    st.markdown("- **النقطة 27:** قفل الترحيل والنسخ السحابي الاحتياطي المشفر عابر القارات.")
    st.markdown("- **النقطة 28:** مطابقة التوقيت الذري العالمي عبر دالة التوقيت الموحد.")
    st.markdown("- **النقطة 29:** قفل التجميد الصارم لإصدارات المكتبات وحظر التحديث المخترق.")
    st.markdown("- **النقطة 30:** قفل الحجز المالي المعزول المسبق لحسابات العقود لحمايتك من الإفلاس.")

    st.subheader("الصندوق 5: منصة الماركت بليس وبنك العمولات والتحويلات")
    st.markdown("- **النقطة 31:** محرك تقسيم الأموال والتحويل الآلي الفوري لعمولتك عبر بوابة الدفع.")
    st.markdown("- **النقطة 32:** بطاقات إبرام التعاقدات الفورية اللوجستية بلمسة واحدة بين الورش والمصانع.")
    st.markdown("- **النقطة 33:** لوحة تتبع ميزانية الخزينة المركزية للمصنع.")
    st.markdown("- **النقطة 34:** حماية رصيد الخزينة وتحديثه بشكل آني.")
    st.markdown("- **النقطة 35:** جدار العزل الضريبي وبراءة الذمة التلقائية من قضايا الـ VAT الأوروبية.")
    st.markdown("- **النقطة 36:** جدول سجل التدقيق الجنائي المشفّر.")
    st.markdown("- **النقطة 37:** بصمة الـ SHA-256 لتوقيع أحداث التدقيق وحمايتها من التلاعب.")
    st.markdown("- **النقطة 38:** نظام تخزين واسترجاع بيانات السجلات الزمنية (Timeseries).")
    st.markdown("- **النقطة 39:** أرشيف حفظ المخططات الهندسية CAD بروابط مشفرة.")
    st.markdown("- **النقطة 40:** مجمع الأدلة الفنية الجاهز لشركات التدقيق والمفتشين البيئيين.")

    st.subheader("الصندوق 6: محرك الكربون والبورصة والتحكيم البيئي والطاقة")
    st.markdown("- **النقطة 41:** محرك حساب مؤشر الكربون والضرائب البيئية الإقليمية.")
    st.markdown("- **النقطة 42:** التوأم الرقمي السحابي خفيف الوزن المبرمج بأكواد الـ SVG.")
    st.markdown("- **النقطة 43:** قفل الـ Air-Lock لتقييد عمل الرافعة والمعدات ليلًا.")
    st.markdown("- **النقطة 44:** محرك تتبع البورصة والتحكيم المالي اللحظي لأسعار الطاقة (Energy Hub).")
    st.markdown("- **النقطة 45:** ربط الذكاء الاصطناعي التوليدي عبر نموذج ميسترال والأدلة المقيدة (RAG).")
    st.markdown("- **النقطة 46:** مصفاة فحص الحروف والبيانات الخارقة عبر مطابقة رياضية صارمة لمنع الهلوسة.")

    st.subheader("الصندوق 7: الورش ومحركات اقتطاع العمولات اللوجستية")
    st.markdown("- **النقطة 47:** محرك البحث والربط الجغرافي للمساحات الشاغرة بالمتر المربع في مدن أوروبا.")
    st.markdown("- **النقطة 48:** نظام جرد وتبادل قطع الغيار والأدوات الصناعية النادرة المربوط بالرموز التسلسلية.")
    st.markdown("- **النقطة 49:** محرك اقتطاع العمولات اللوجستية التلقائي المعزول وإرسالها لهاتفك في السماوة، العراق.")
